...
import 'add_income_screen.dart'; // Import AddIncomeScreen for date picker logic
...
class _EditIncomeScreenState extends State<EditIncomeScreen> {
  ...
  void _deleteIncome() async {
    ...
    if (confirmDelete == true) {
      context.read<IncomeViewModel>().deleteIncome(widget.income.id);
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<IncomeViewModel>().updateIncome(updatedIncome);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('EDIT INCOME'), // Updated title
